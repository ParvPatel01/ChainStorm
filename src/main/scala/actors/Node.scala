...
import actors.Blockchain._
import actors.Miner.{Ready, Validate}
import actors.Node.*
import blockchain.*
...
object Node {
  ...
  case class AddBlockMessage(proof: Long, transaction: List[Transaction], timestamp: Long) extends NodeMessage
